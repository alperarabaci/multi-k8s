...
kubectl set image deployments/client-deployment client=alperarabaci/multi-client:$SHA
kubectl set image deployments/worker-deployment worker=alperarabaci/multi-worker:$SHA